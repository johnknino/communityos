...
(function(){
  ...
  function buildCivicLoop() {
    ...
    var communityPages = ['discuss','needs','propose','evaluate','connect','govern','dashboard','grow','how-it-works','survive','understand','audit','assess','intelligence','share','story','contribute','support','learn'];
