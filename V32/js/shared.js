...
(function(){
  ...
  function buildFooter(closingKey) {
    ...
    trustBar.innerHTML = '<div class="trust-badges">' +
      '<span>Richard J. Daley College</span><span class="sep">·</span>' +
      '<span>City Colleges of Chicago</span><span class="sep">·</span>' +
      '<span>Hispanic-Serving Institution</span><span class="sep">·</span>' +
      '<span>IRB Approved</span><span class="sep">·</span>' +
    ...
    footer.innerHTML = (closingKey ? '<div class="footer-closing" data-t="' + closingKey + '">' + t(closingKey) + '</div>' : '') +
      ...
      '<div class="footer-opensource"><a href="https://github.com/johnknino/communityos" target="_blank" rel="noopener">Open source · GitHub ↗</a></div>';
    var page = document.querySelector('.page');
    ...
    btabs.innerHTML = '<div class="bottom-tabs-inner">' +
      ...
      '<button class="btab" onclick="EQ.toggle()"><span class="btab-icon">🌐</span><span class="btab-label">' + (lang === 'es' ? 'EN' : 'ES') + '</span></button>' +
      '</div>';
