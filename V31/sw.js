...
var CACHE_NAME = 'communityos-v31d';
var ALL_PAGES = [
  ...
  '/defend','/benefits-check','/health-calc','/complaints','/food-safety','/drug-prices',
  '/worker-rights','/school-rights','/court-nav','/lending','/building-safety',
  '/benefits-screener','/environment','/311','/disaster','/neighborhood','/crisis','/how-it-works','/journeys','/crisis','/tos','/champion'
];
var CRITICAL_ASSETS = [
  '/css/shared.css','/js/shared.js','/data/plant_database.json',
  '/data/knowledge_guides.json',
