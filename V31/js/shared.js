...
(function(){
  ...
  var NAV_LINKS = [
    ...
    { href: '/defend.html', key: 'nav_defend', label: 'Defend Yourself', labelEs: 'Defiéndete' },
    { href: '/benefits-check.html', key: 'nav_benefits', label: 'Benefit Safety Check', labelEs: 'Seguridad de Beneficios' },
    { href: '/health-calc.html', key: 'nav_healthcalc', label: 'Health Risk Check', labelEs: 'Riesgo de Salud' },
    { href: '/drug-prices.html', key: 'nav_drugs', label: 'Drug Price Check', labelEs: 'Precios de Medicamentos' },
    { href: '/food-safety.html', key: 'nav_food', label: 'Food Safety Check', labelEs: 'Seguridad Alimentaria' },
    { href: '/complaints.html', key: 'nav_complaints', label: 'Complaint Lookup', labelEs: 'Búsqueda de Quejas' },
    { href: '/worker-rights.html', key: 'nav_worker', label: 'Worker Rights', labelEs: 'Derechos del Trabajador' },
    ...
    { href: '/building-safety.html', key: 'nav_building', label: 'Building Safety', labelEs: 'Seguridad de Edificios' },
    ...
    { href: '/311.html', key: 'nav_311', label: '311 Tracker', labelEs: 'Rastreador 311' },
    { href: '/disaster.html', key: 'nav_disaster', label: 'Disaster Ready', labelEs: 'Preparación para Desastres' },
    { href: '/neighborhood.html', key: 'nav_neighborhood', label: 'My Neighborhood', labelEs: 'Mi Vecindario' },
    { href: '/crisis.html', key: 'nav_crisis', label: 'I Need Help Now', labelEs: 'Necesito Ayuda Ahora' },
    { href: '/how-it-works.html', key: 'nav_how', label: 'How This Works', labelEs: 'Cómo Funciona' },
    { href: '/journeys.html', key: 'nav_journeys', label: 'Life Guides', labelEs: 'Guías de Vida' },
  ...
  function buildCivicLoop() {
    ...
    // SVG connections with marching ants + flowing energy dots
    var svgHtml = '<svg class="cl-svg" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">' +
      '<circle cx="150" cy="150" r="95" fill="none" stroke="rgba(91,140,122,.05)" stroke-width="1"/>' +
      '<path class="conn" id="clc01" d="M172,35 Q250,58 254,128" stroke="rgba(91,140,122,.1)" stroke-width="1" fill="none"/>' +
      '<path class="conn" id="clc12" d="M260,165 Q252,235 220,262" stroke="rgba(91,140,122,.1)" stroke-width="1" fill="none" style="animation-delay:-.6s"/>' +
      '<path class="conn" id="clc23" d="M130,278 Q80,272 55,244" stroke="rgba(91,140,122,.1)" stroke-width="1" fill="none" style="animation-delay:-1.2s"/>' +
      '<path class="conn" id="clc34" d="M36,172 Q28,96 54,60" stroke="rgba(91,140,122,.1)" stroke-width="1" fill="none" style="animation-delay:-1.8s"/>' +
      '<path id="clc40" d="M88,34 Q118,18 146,26" stroke="rgba(212,112,74,.08)" stroke-width="1.5" fill="none" stroke-dasharray="5,4"/>' +
      '<defs><filter id="clDg" x="-100%" y="-100%" width="300%" height="300%"><feGaussianBlur in="SourceGraphic" stdDeviation="2.5"/><feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge></filter>' +
      '<filter id="clDgc" x="-100%" y="-100%" width="300%" height="300%"><feGaussianBlur in="SourceGraphic" stdDeviation="2"/><feMerge><feMergeNode/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs>' +
      '<circle r="2.5" fill="#5CE0D4" opacity=".6" filter="url(#clDg)"><animateMotion dur="3.2s" repeatCount="indefinite"><mpath href="#clc01"/></animateMotion></circle>' +
      '<circle r="2.5" fill="#5CE0D4" opacity=".6" filter="url(#clDg)"><animateMotion dur="3.7s" begin=".7s" repeatCount="indefinite"><mpath href="#clc12"/></animateMotion></circle>' +
      '<circle r="2.5" fill="#5CE0D4" opacity=".6" filter="url(#clDg)"><animateMotion dur="3.4s" begin="1.3s" repeatCount="indefinite"><mpath href="#clc23"/></animateMotion></circle>' +
      '<circle r="2.5" fill="#5CE0D4" opacity=".6" filter="url(#clDg)"><animateMotion dur="3.9s" begin="2s" repeatCount="indefinite"><mpath href="#clc34"/></animateMotion></circle>' +
      '<circle r="2" fill="#FF8A5C" opacity=".5" filter="url(#clDgc)"><animateMotion dur="4.5s" begin="2.8s" repeatCount="indefinite"><mpath href="#clc40"/></animateMotion></circle>' +
      '</svg>';
  ...
  function getCacheVersion() { return 'communityos-v31'; }
